...
export default function GamifiedPage() {
  const levels = [
    ...
    },
    {
      ...
      card: "right",
      cat: "Социальные сети",
      title: "Безопасность в соц сетях",
      x: 885,
      y: 700,
    },
    {
    ...
    <div className="gamified-page">
        ...
        <div className="gamified-hero-inner">
          ...
          <div className="gamified-progress-card">
            ...
            <div className="gamified-progress-line">
              <div className="gamified-progress-fill" />
            </div>
          ...
          {levels.map((item) => (
            ...
            >
              <div className={`map-circle ${item.type}`}>
                <MdiIcon path={item.icon} size={46} />
      ...
      <section className="bonus-section">
        <div className="bonus-card">
          <div className="bonus-circle" aria-hidden="true" />

          <h2>Бонусы Halyk Bank!</h2>

          <p className="bonus-subtitle">За каждый пройденный уровень</p>
          ...
          <div className="bonus-list">
            ...
            <div className="bonus-item">
              <div className="bonus-gift">
                <MdiIcon path={mdiGiftOutline} size={34} />
              </div>
